...
//    UIImageView *temImageView = [UIImageView new];
    
//    [temImageView sd_setImageWithURL:[NSURL URLWithString:self.playingMusic.icon]];
    
    UIImageView *image = [UIImageView new];
    [image sd_setImageWithURL:[NSURL URLWithString:self.playingMusic.icon] completed:^(UIImage * _Nullable image, NSError * _Nullable error, SDImageCacheType cacheType, NSURL * _Nullable imageURL) {
        infos[MPMediaItemPropertyArtwork] = [[MPMediaItemArtwork alloc] initWithImage:image];
    }];
